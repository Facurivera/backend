...
import cartController from "./cartCont.mjs";
...
export const createPayment = async (req, res) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: `https://backend-production-616f.up.railway.app/payment/payment-success?session_id={CHECKOUT_SESSION_ID}&cart_id=${cartId}`,
      cancel_url:
        "https://backend-production-616f.up.railway.app/cancel",
    });
